(function() {
    ...
    function inject() {
        ...
        if (!container || container.querySelector('#addGameButton')) return;

        container.insertAdjacentHTML('afterbegin', `
        <div style="-webkit-app-region:no-drag; display:flex; align-items:center; gap:8px; margin-right:8px;">
            <div class="_2Lu3d-5qLmW4i19ysTt2jT"><div class="" style="font-size:12px;">OpenSteam is active and ready to use</div></div>
