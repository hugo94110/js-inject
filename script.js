...
//                                                     Add a game to your library by entering its AppID. You can find every AppID's on <a href="#">https://steamdb.info</a><br><br>
//                                                 </div>
...
(function() {
    ...
    function inject() {
        ...
        if (!container.querySelector('#githubButton')) {
